...
#define ALLY_CENTER_COLOR GREEN
#define ENEMY_CENTER_COLOR RED

#define MIN_BALL_AREA 200
#define MAX_BALL_AREA 100000
#define MIN_CENTER_AREA 200
#define MAX_CENTER_AREA 100000
#define MAX_IDENTIFIER_DISTANCE 500

#define N_PLAYERS 3
#define N_COLOR_IDENTIFIERS 1
#define IDENTIFIER_COLOR_1 BLUE
#define IDENTIFIER_COLOR_2 VIOLET
